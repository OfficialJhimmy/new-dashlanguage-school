...
import SpanishTable from "../../components/Table/SpanishTable";
  ...
  return (
    <>
      ...
      <section>
        ...
        <SpanishTable />
        <Link
          to="/nigeria-to-spain-dash-ieae-valencia-culinary-success"
          className="learn-more-link"
        >
          Discover how DASH Language School and Instituto IEAE Valencia can turn
          your culinary dreams into reality. Click to learn more!
        </Link>
      </section>
    </>
  );
