...
function WhatWeDo() {
  return (
    <div className="whatwedo">
      ...
      <p>
        We teach and prepare our students for GERMAN (GOETHE ZERTIFIKAT), FRENCH
        (DELF-DALF), SPANISH, AND PORTUGUESE, and Mandarin International examinations from A1
        to C1. We also translate and transcribe your videos, Audios and
        documents from German to English, French to English, Spanish to English,
        and Portuguese to English and your target language. Our other services
        are admission processing to international universities, work and
        training visa applications, and family reunion Visa applications.
      </p>
      <div className="whatwedo__parent">
        <div className="whatwedo-wrapper">
          <Link to="/bfd">
            ...
            <h4>Nursing Ausbildung, BFD, FSJ Migration in Germany </h4>
            <p className="whatwedo-p">
              If you're an African looking for a unique opportunity to volunteer
              work in Germany and gain valuable experience, you may want to
              consider participating in the BFD or (FSJ).
            </p>
          </Link>
        </div>

        <div className="whatwedo-wrapper">
          <Link to="/die-chancekarte">
            <div className="whatwedo__image-wrapper">
              <img
                src={Job}
                alt="Dash Language Place"
            ...
            <p className="whatwedo-p">
              ...
              skills and expertise to Germany's industries.{" "}
            </p>
          </Link>
        </div>
        ...
        <div className="whatwedo-wrapper">
          <Link to="/language-support">
            ...
            <p className="whatwedo-p">
              We provide comprehensive language education and support to Diploma
              levels, by preparing our students for successful university-level
              studies to have a Degree in foreign languages.
            </p>
          </Link>
        </div>
        ...
        <div className="whatwedo-wrapper">
          <Link to="/our-courses">
            ...
            <p className="whatwedo-p">
              We offer German, French, Spanish, and Portuguese language courses
              at each level. From A1 to C1. You will learn at your own pace for
        ...
        <div className="whatwedo-wrapper">
          <Link to="/admission">
            ...
            <p className="whatwedo-p">
              ...
              or a language course in German, French, Spanish, and
              Portuguese-speaking countries. Not to worry we've got you covered
            </p>
          </Link>
        </div>
        <div className="whatwedo-wrapper">
          <Link to="/exam-preparation">
            ...
            <p className="whatwedo-p">
              ...
              ZERTIFIKAT,DELF-DALF, SPANISH AND PORTUGUESE examinations on each
              level. Your success is very important to us.
            </p>
          </Link>
        </div>
        <div className="whatwedo-wrapper">
